                ...
                <div className="col-xl-6" style={{height:"100%",}}>
                    <div className="card">
                        <div className="card-body pb-2">
                            <br></br>
                            <h1 className="text-center no-border font-w600 fs-60 mt-2"><span className="text-warning">Buy</span>  BXG at the<br/> BitxGold with no additional charges</h1>
                            ...
                            <div className="row">
                                <div className="col-xl-12">
                                        ...
                                        <div className="col-xl-12 justify-content-center" >
                                            <div className="row justify-content-center">
                                                <div className="col-xl-6">
                                                    <input onChange={handleChange} type="text" className="form-control mb-3" name="value" placeholder="" defaultValue={bxgvalue} />
                                                </div>
                                        ...
                                        <div className="col-xl-12">
                                            <div className="row justify-content-center">
                                                <div className="col-xl-6">
                                                    ...
                                                    <input disabled= {true} type="text" className="form-control mb-3"value = {totalUsd} name="value" placeholder="12" defaultValue={totalUsd} />
                                    ...
                                    <div className="text-center mt-4 mb-4">
                                        <Link to={"/p2p"} className="btn btn-warning mr-0 " >BUY NOW</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
