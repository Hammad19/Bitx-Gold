										...
										<div className="">
											<div className="buy-sell">
												<Nav className="nav nav-tabs" eventKey="nav-tab2" role="tablist">
													<Nav.Link as="button" className="nav-link" eventKey="Navbuy" type="button">Stake</Nav.Link>
													<Nav.Link as="button" className="nav-link" eventKey="Navsell"  type="button">Claim</Nav.Link>
												</Nav>
											</div>
											<Tab.Content  >
												...
												<Tab.Pane eventKey="Navsell">
													<Tab.Container defaultActiveKey="Navsellmarket">
														...
														<div className="sell-element">
															<OrderForm />
                                                            <div className="text-center">
					                                            <Link to={"/exchange"} className="btn btn-primary w-75">Claim</Link>
			                                            	</div>
														</div>	
													</Tab.Container>
												</Tab.Pane>
